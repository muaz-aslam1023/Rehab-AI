import { FaUser, FaClipboardList, FaDumbbell, FaChartLine, FaFileAlt, FaBars, FaTimes, FaSignOutAlt, FaChartPie } from "react-icons/fa";
...
export default function Navbar() {
  ...
  const menuItems = [
    { icon: <FaClipboardList />, label: "Overview", href: "/overview" },
    { icon: <FaDumbbell />, label: "Exercises", href: "/exercises" },
    { icon: <FaChartLine />, label: "Performance", href: "/performance" },
    { icon: <FaChartPie />, label: "Reports", href: "/reports" },
    { icon: <FaFileAlt />, label: "Calories Predictor", href: "/calories-predictor" },
  ];
