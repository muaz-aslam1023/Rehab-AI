                    ...
                    <div className="flex flex-wrap items-center gap-4">
                        ...
                        <div className="relative z-50">
                            <button
                                ...
                                className="bg-[#1e2330] border border-slate-700/50 shadow-lg hover:border-teal-500/50 hover:shadow-teal-500/10 transition-all px-4 py-2.5 rounded-xl flex items-center gap-3 text-sm font-semibold text-slate-300 min-w-[220px] justify-between"
                            >
                ...
                {loading ? (
                    ...
                    <div className="bg-slate-50 border-2 border-dashed border-slate-200 rounded-3xl p-12 flex flex-col items-center justify-center text-center">
                        ...
                        <p className="text-slate-500 max-w-sm mx-auto mb-6">
                            {selectedPatientId ? "This patient hasn't completed any sessions for the selected criteria." : "Please select a patient to view their performance metrics."}
                        </p>
                    </div>
                )}
...
export default Doctor_Performance;
